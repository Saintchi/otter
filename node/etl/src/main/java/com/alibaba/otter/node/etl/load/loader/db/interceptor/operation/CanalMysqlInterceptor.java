...
public class CanalMysqlInterceptor extends AbstractOperationInterceptor {
    ...
    // 去掉ON DUPLICATE KEY UPDATE {1} = VALUES({1})
    public static final String mergeofMysqlSql     = "INSERT INTO {0} (id, {1}) VALUES (?, ?) ";

    // 去掉ON DUPLICATE KEY UPDATE {1} = VALUES({1}) , {2} = VALUES({2})
    public static final String mergeofMysqlInfoSql = "INSERT INTO {0} (id, {1}, {2}) VALUES (?, ? ,?)";
