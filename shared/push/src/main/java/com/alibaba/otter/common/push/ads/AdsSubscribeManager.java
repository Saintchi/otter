...
package com.alibaba.otter.common.push.ads;
 ...
 * @version 4.1.8
 */
public class AdsSubscribeManager extends AbstractSubscribeManager {

    private static final Long                   DEFAULT_PERIOD = 60 * 1000L;
    private static final Logger                 logger         = LoggerFactory.getLogger(AdsSubscribeManager.class);
